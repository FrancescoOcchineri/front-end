...
let mapArray = sumNum.map(n => n + 10 ) 
...
stringArray = ["Ciao", "a", "tutti"];

let newMapArray = stringArray.map(n => n.length + " e il numero di caratteri")
